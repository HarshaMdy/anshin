// Onboarding screen B — "How often does this happen?" — Content Bible §3b
// Single-select from 5 options. Continue routes to screen C.
...
class OnboardingBScreen extends ConsumerStatefulWidget {
  const OnboardingBScreen({super.key});

  @override
  ConsumerState<OnboardingBScreen> createState() => _OnboardingBScreenState();
}

class _OnboardingBScreenState extends ConsumerState<OnboardingBScreen> {
  String? _selected;
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () => context.canPop()
              ? context.pop()
              : context.go(AppRoutes.onboardingA),
        ),
...
// ─────────────────────────────────────────────────────────────────────────────
// Step indicator (shared pattern — step 2 of 3)
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// Option tile (single-select, mirrors OnboardingA)
// ─────────────────────────────────────────────────────────────────────────────
