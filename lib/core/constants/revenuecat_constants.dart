...
// Play Store subscription product IDs (base:offer format)
const String kRcProductMonthly = 'anshin_premium:monthly';
const String kRcProductAnnual  = 'anshin_premium:annual';
